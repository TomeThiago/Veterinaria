...
module.exports = {
	async index(req, res) {
		try {
			...
			return res.status(HTTPStatus.INTERNAL_SERVER_ERROR).json({ messagem: "Erro ao listar os anexos!" });
		}
	},
	...
	async store(req, res) {
		try {
			...
			return res.status(HTTPStatus.INTERNAL_SERVER_ERROR).json({ messagem: "Erro ao cadastrar o anexo!" });
		}
	},
	...
	async delete(req, res) {
		...
		try {
			...
			return res.json({ message: "Erro ao deletar o anexo!" })
		}
	}
}